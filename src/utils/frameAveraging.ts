import { PostureFrame, AveragedPosture } from '../types/index.js';

export function averageFrames(frames: PostureFrame[]): AveragedPosture {
  if (frames.length === 0) {
    return {
      neck_angle: 0,
      back_angle: 0,
...
export function formatPostureForPrompt(posture: AveragedPosture): string {
